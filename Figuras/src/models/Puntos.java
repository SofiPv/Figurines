...
public class Puntos implements Iterable<Punto>, IDrawable {
	...
	public Puntos(int capacity) {
		puntos = new Punto[capacity];
	}

	public boolean setValueAt(int index, Punto point) {
	...
	public boolean setValueAt(int index, Point point) {
		...
		try {
			puntos[index] = new Punto((double) point.x, (double) point.y);
		} catch (Exception ex) {
			return false;
		}
	...
	public Punto getValueAt(int index) {
